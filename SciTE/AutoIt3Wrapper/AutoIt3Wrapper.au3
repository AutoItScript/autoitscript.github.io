#NoTrayIcon
Global Const $VERSION = "15.920.938.0"
...
#AutoIt3Wrapper_Res_Fileversion=15.920.938.0
...
;~ 						$Pragma_ = $PragmaOption[1]
		...
		If $I_Rec = "#RequireAdmin" and Not IsAdmin() Then
